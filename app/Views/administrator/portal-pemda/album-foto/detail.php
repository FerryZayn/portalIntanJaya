            ...
            <div class="row mt--2">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-text">
                                <h2 class="fw-bold"><?= $v_albumfoto->judul; ?></h2>
                                <div class="flex-1 ml-3 pt-1">
                                    <h6 class="text-uppercase fw-bold mb-1"><i class="icon-user"></i> <?= $v_albumfoto->nama_pengarang; ?>
                                        <span class="text-info pl-3"><i class="icon-clock"></i>
                                            <?php
                                            echo date('d F Y - H:i:s', strtotime($v_albumfoto->created_date));
                                            ?>
                                        </span>
                                        <span class="text-success pl-3"><?= $v_albumfoto->tipe; ?></span>
                                        <span class="text-success pl-3"><?= $v_albumfoto->kategori; ?></span>
                                        <span class="text-success pl-3"><?= $v_albumfoto->nama_status; ?></span>
                                    </h6>
                                </div>
                                <p><?= $v_albumfoto->isi_artikel; ?></p>
                            </div>
                        </div>
                    </div>
                </div>
