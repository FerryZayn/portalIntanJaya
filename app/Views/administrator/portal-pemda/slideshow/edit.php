                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="/PemdaController/updateSlideshow/" enctype="multipart/form-data">
                                <?= csrf_field(); ?>
                                <input type="hidden" name="_method" value="put">
                                <input type="hidden" name="id" value="<?= $v_slideshow->id; ?>">
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                <input type="text" name="judul" value="<?= $v_slideshow->judul; ?>" class="form-control" placeholder="Judul Artikel">
                                            </div>
                                            <div class="mb-3">
                                                <textarea name="isi_artikel" class="form-control" id="deskberita"><?= $v_slideshow->isi_artikel; ?></textarea>
                                            </div>
                                            <div class="mb-3">
                                                <div class="row">
                                                    <div class="col-2">
                                                        <img src="<?= base_url(); ?>/templet/gambar-berita/<?= $v_slideshow->file_gambar; ?>" class="img-thumbnail img-preview">
                                                    </div>
                                                    <div class="col-10">
                                                        <div class="mb-3">
                                                            <input type="text" name="nama_pengarang" value="<?= $v_slideshow->nama_pengarang; ?>" class="form-control" placeholder="Nama Pengarang">
                                                        </div>
                                                        <div class="mb-3">
