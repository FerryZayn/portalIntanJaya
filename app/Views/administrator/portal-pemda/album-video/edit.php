                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="/PemdaController/updateArtikel/" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="id" value="<?= $v_albumvideo->id; ?>">
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                <input type="text" name="judul" value="<?= $v_albumvideo->judul; ?>" class="form-control" placeholder="Judul Artikel">
                                            </div>
                                            <div class="mb-3">
                                                <textarea name="isi_artikel" class="form-control" id="deskberita"><?= $v_albumvideo->isi_artikel; ?></textarea>
                                            </div>
                                            <div class="mb-3">
                                                <div class="row">
                                                    <div class="col-2">
                                                        <img src="<?= base_url(); ?>/templet/gambar-berita/<?= $v_albumvideo->file_gambar; ?>" class="img-thumbnail img-preview">
                                                    </div>
                                                    <div class="col-10">
                                                        <div class="mb-3">
                                                            <input type="text" name="nama_pengarang" value="<?= $v_albumvideo->nama_pengarang; ?>" class="form-control" placeholder="Nama Pengarang">
                                                        </div>
                                                        <div class="mb-3">
                                ...
                                <div class="modal-footer no-bd">
                                    ...
                                    <a href="/administrator/portal-pemda/album-video/home" class="btn btn-danger"><i class="fas fa-times-circle"></i> Batalkan...</a>
                                </div>
                            </form>
                        </div>
                    </div>
