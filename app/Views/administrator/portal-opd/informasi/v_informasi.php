                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h4 class="card-title">Daftar Artikel Informasi</h4>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $informasi['nama_status']; ?></td>
                                                <td>
                                                    <?php
                                                    if ($informasi['nama_status'] == "publish") {
                                                    ?>
                                                        <a href="/administrator/portal-opd/penarikan-artikel/<?= $informasi['id']; ?>" data-toggle="tooltip" class="btn btn-success btn-sm" data-original-title="Penarikan...">
                                                            <i class="fas fa-directions"></i> Tarik
                                                        </a>
                                                    <?php
                                                    } else {
                                                    ?>
                                                        <a href="/administrator/portal-opd/publish/<?= $informasi['id']; ?>" data-toggle="tooltip" class="btn btn-success btn-sm" data-original-title="Publish...">
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        <a href="/administrator/portal-opd/detail-artikel/<?= $informasi['id']; ?>" data-toggle="tooltip" class="btn btn-info btn-sm" data-original-title="Lihat detail data...">
                                                            <i class="fa fa-eye"></i>
                                                        </a>&nbsp;
